...
public class MainActivity extends BaseActivity implements  NavigationDrawerFragment.NavigationDrawerCallbacks{
   ...
   //private AdcashInterstitial mInterstitial;
    ...
    /**
     * Alternatively, you can display Interstitial when you are ready to
     * display it. Just invoke showInterstitial() when ready:
     */
   /* public void showInterstitial() {
    ...
    private Intent getDefaultIntent() {
        ...
        intent.putExtra(Intent.EXTRA_TEXT, "http://livestreamtv.biz/apptvcanais/canaltv/redirect/php_gplay.php");
        return intent;
    }
